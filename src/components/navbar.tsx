export function Navbar() {
  return (
    <nav className='bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-900 sticky top-0'>
      <div className='container flex flex-wrap items-center justify-around mx-auto'>
        {/* <a href='.' className='flex items-center'>
          <img src='/snake.svg' className='h-6 mr-3 sm:h-7' alt='Medusa logo' />
